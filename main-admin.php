...
WPF\Loader::_require_once( 'wpf_gui_setting_validator_base.php' );
...
new WPF\Plugin\Part\Advanced (
	new WPF\GUI\Setting\Page\PluginOptions(
		new WPF\GUI\Setting\Page\Section\Base( 'rfc7234', __( 'RFC 7234 HTTP 1.1 Cache-Control headers options', TEXTDOMAIN )
			, new WPF\GUI\Setting\Page\Control\RadioButtons( 'dont_rewrite_cache_control', CACHE_CONTROL_REWRITE_MODE
				, array(
				...
				, new WPF\GUI\Setting\Validator\Base(
			...
			, new WPF\GUI\Setting\Page\Control\Input( 'no_cache', NO_CACHE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\CheckBox( 'no_store', NO_STORE
				, array(
				...
				, new WPF\GUI\Setting\Validator\Base( null, null, null, \FILTER_VALIDATE_BOOLEAN )
			)
			, new WPF\GUI\Setting\Page\Control\CheckBox( 'public', CACHE_PUBLIC
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\Input( 'private', CACHE_PRIVATE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\Number( 'max_age', MAX_AGE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\CheckBox( 'must_revalidate', MUST_REVALIDATE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\CheckBox( 'proxy_revalidate', PROXY_REVALIDATE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\CheckBox( 'no_transform', NO_TRANSFORM
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\Input( 'vary', VARY
				, array(
		...
		, new WPF\GUI\Setting\Page\Section\Base( 'rfc5861', __( 'RFC 5861 HTTP Cache-Control Extensions for Stale Content', TEXTDOMAIN )
			, new WPF\GUI\Setting\Page\Control\Number( 'stale_while_revalidate', STALE_WHILE_REVALIDATE
				, array(
			...
			, new WPF\GUI\Setting\Page\Control\Number( 'stale_if_error', STALE_IF_ERROR
				, array(
